...
var data = {
    ...
    work: {
        "jobs": [
            {
                employer: "Lennox International",
                title: "Software Development Engineer in Test (SDET)",
                location: "Carrollton, TX",
                dates: "March 2026 to Present",
                brief: "Developing comprehensive automated tests for HVAC hardware-in-the-loop systems.",
                description: "Started as a contractor in March 2026 and converted to a Lennox employee in late May 2026. Creating automated tests that exercise device configuration and test execution for the latest release.",
                roles: [
                    {
                        title: "Test Automation Engineer",
                        date: "2026",
                        description: "Developing comprehensive tests for HVAC hardware-in-the-loop systems using Python, TCP/IP, and serial communications. Built test coverage for device configuration and test execution workflows supporting the current release."
                    },
                ],
